...
public void dardealtaventa(){
    Date hoy=new Date();
    Venta venta = new Venta("libros","001",hoy.toString(),"UPC",hoy.toString(),hoy.toString(),"nuevo",300.00,"Soles");
    ...
    Assert.assertNotNull(venta.getIgv());
    Assert.assertNotNull(venta.getMoneda());
    Assert.assertNotNull(venta.getTotal());
...
public void buscarventasegunnumero(){
    ...
    Date hoy=new Date();
    Venta venta = new Venta("libros","001",hoy.toString(),"UPC",hoy.toString(),hoy.toString(),"nuevo",150.00,"Soles");
...
public void buscarventasegunempresa(){
    ...
    Date hoy=new Date();
    Venta venta = new Venta("libros","002",hoy.toString(),"UPC",hoy.toString(),hoy.toString(),"nuevo",220.00,"soles");
